...
type HeroDialogProps = {
  ...
  heroError: string;
  setHeroError: (value: string) => void;
  isBusy: boolean;
  isPending: boolean;
  isUploadingHero: boolean;
  setIsUploadingHero: (value: boolean) => void;
          ...
          <div className="overflow-y-auto px-4 py-4 sm:px-6">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm text-white/60">Hero title</label>
                <input
                  type="text"
                  ...
                  <div className="overflow-hidden border border-white/10 bg-white/[0.02]">
                    ...
                    <div className="flex flex-col gap-3 border-t border-white/10 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                      <div>
                        ...
                        <p className="text-xs text-white/35">Ready to save</p>
                      </div>
