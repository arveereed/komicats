      ...
      <div className="relative z-10 w-full max-w-[480px]">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-xl sm:p-10">
          <div className="mb-8 text-center">
            ...
            <Skeleton className="mx-auto h-8 w-40 sm:h-9 sm:w-48" />
            <Skeleton className="mx-auto mt-3 h-4 w-36 sm:w-44" />
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="pt-2 text-center">
              <Skeleton className="mx-auto h-4 w-48 sm:w-56" />
            </div>
          </div>
          ...
          <div className="mt-8 flex items-center justify-center gap-3 text-sm text-white/60">
            ...
            <span>Preparing your sign-in experience...</span>
          </div>
        </div>
      </div>
    </div>
